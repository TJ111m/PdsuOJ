  ...
  <div class="row" id="submit-buttons">
    <div class="column">
      <div class="ui buttons">
	      ...
	      echo "<a class=\"small ui positive button\" href=\"status.php?problem_id=$PID[$pid]&cid=$cid\">$MSG_GLOBAL$MSG_SUBMIT_RECORD</a>";
...
$(document).ready(function() {
    ...
    $(document).mousemove(function(event) {
        if (isDragging) {
            ...
            let maxWidth = document.body.clientWidth * 2 / 3;
            let minWidth = document.body.clientWidth / 3;
