...
<?php if (isset($id)){?>
<span style="color:#0000ff; font-size: 20px;">问题 <b><?php echo $id?></b></span>
...
<?php }?>
<span id="language_span"style="font-size: 20px;">编程语言: 
<select id="language" name="language" style="font-size: 20px;" onChange="reloadtemplate($(this).val());" >
<?php
...
<?php }?>
<button  id="Submit" type="button" class="ui primary icon button" style="position: relative; top: -5px;" onclick="do_submit();"><?php echo $MSG_SUBMIT?></button>
