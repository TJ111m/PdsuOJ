...
<div style="text-align: center; ">
  <div class="ui pagination menu" style="box-shadow: none; ">
    <a class="<?php if($page==1) echo "disabled "; ?>icon item" href="problemset.php?page=1<?php echo htmlentities($postfix,ENT_QUOTES,'UTF-8'); ?>" id="page_first">
    ...
    <a class="<?php if($page==$view_total_page) echo "disabled "; ?> icon item" href="problemset.php?page=<?php echo $view_total_page . htmlentities($postfix,ENT_QUOTES,'UTF-8'); ?>" id="page_last">
...
<?php } ?>
  ...
  <table class="ui very basic center aligned table" style="font-size: 1.3em;">
    <thead>
      <tr>
